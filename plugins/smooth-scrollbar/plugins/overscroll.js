  ...
  return function (t) {
    ...
    ***************************************************************************** */
    var r = function (t, e) {
      ...
      }, s = o(1), c = "object" == typeof self && self && self.Object === Object && self,
      l = s.a || c || Function("return this")(), a = l.Symbol, u = Object.prototype, h = u.hasOwnProperty,
      f = u.toString, p = a ? a.toStringTag : void 0, d = Object.prototype.toString, v = a ? a.toStringTag : void 0,
      y = function (t) {
      ...
      }, _ = /^\s+|\s+$/g, b = /^[-+]0x[0-9a-f]+$/i, m = /^0b[01]+$/i, x = /^0o[0-7]+$/i, g = parseInt,
      O = function (t) {
    ...
    var A, C = function () {
      ...
      return t.prototype.render = function (t) {
        var e = t.x, o = void 0 === e ? 0 : e, r = t.y, n = void 0 === r ? 0 : r, i = this._scrollbar, s = i.size,
          c = i.track, l = i.offset;
      ...
      return t.prototype.mount = function () {
        ...
        var t = this._scrollbar.size, e = window.devicePixelRatio || 1, o = t.container.width * e,
        ...
        var e = this._scrollbar.size, o = this._getMaxOverscroll(), r = e.container, n = r.width, i = r.height,
          s = this._ctx;
    ...
    var B = /wheel|touch/, z = function (t) {
      ...
      return function (t, e) {
        ...
        var o = this.options, r = this.scrollbar, n = this._amplitude, i = this._position, s = n[t], c = e * s < 0,
        ...
        var e = this.options, o = this._amplitude, r = this._position, n = 1 - e.damping, i = o[t], s = r[t],
          c = this._touching ? i : i * n | 0, l = c - s, a = s + l - (l * n | 0);
