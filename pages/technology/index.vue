<template lang="pug">
  .technology
    section.technology__title(data-anim="fadeIn" data-anim-delay="0" :style="{opacity: this.$store.state.isMobile ? 1 : 0, transform: this.$store.state.isMobile ? 'translate(0, 0)' : 'translate(0, 10%)'}") Technology
    ...
    section.technology__about3(data-anim="fadeIn" data-anim-delay="0" :style="{opacity: this.$store.state.isMobile ? 1 : 0, transform: this.$store.state.isMobile ? 'translate(0, 0)' : 'translate(0, 10%)'}")
                        | World Class Swiss Finance Technology clients with integrated:
                        br
                        br
                        | - Open Banking
                        br
                        ...
                        br
                        br
                        | allowing instant execution, clearing and settlement of bullion transactions.

    section.technology__benefits(data-anim="fadeIn" data-anim-delay=".3" :style="{opacity: this.$store.state.isMobile ? 1 : 0}") Benefits
    section.technology__listLinks
      DoubleLinkList(:list="innerPages")
    section.technology__video
      CustomVideo(largeImgUrl="videoNew.jpg" smallImgUrl="videoNew.jpg" :isMobile="isMobile" title="Global Banking & Finance<br>Awards 2018" smallSize="200%" :key="isMobile" path="/payments/awards")
    ...
    section.technology__adv(data-anim="fadeIn" data-anim-delay=".3" :style="{opacity: this.$store.state.isMobile ? 1 : 0}")
      .technology__adv_title Apply for a
      .technology__adv_desc Private Swiss vault account
...
export default {
  name: "Technology",
  head: {
    title: "Golden Suisse - Technology"
  },
  components: {
    CustomVideo,
    DoubleLinkList,
...
.technology {
  ...
  grid-template-areas:
    ...
    ". about1 about1 . . about3 about3 about3 about3 ."
